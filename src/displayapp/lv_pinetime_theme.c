...
static void basic_init(void) {
  ...
  lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  ...
  lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT, LV_COLOR_GRAY);
  lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  ...
  lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  lv_style_set_bg_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_GREEN);
  lv_style_set_bg_color(&style_btn, LV_STATE_DISABLED, LV_IT_COLOR_BUTTON_DISABLED);
  lv_style_set_bg_color(&style_btn, LV_STATE_DISABLED | LV_STATE_CHECKED, LV_COLOR_GRAY);
  ...
  lv_style_set_value_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
  lv_style_set_value_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
  ...
  lv_style_set_value_color(&style_back, LV_STATE_DEFAULT, LV_COLOR_GRAY);
  ...
  lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, LV_COLOR_SILVER);
  ...
  lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_GRAY);
  lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, lv_color_darken(LV_COLOR_GRAY, LV_OPA_20));
  lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
  lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_COLOR_WHITE);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_COLOR_WHITE);
  ...
  //lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_COLOR_GRAY);
  lv_style_set_bg_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_COLOR_GRAY);

  style_init_reset(&style_ddlist_selected);
  lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);

  style_init_reset(&style_sw_bg);
  lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, LV_COLOR_SILVER);
  lv_style_set_radius(&style_sw_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
  lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  ...
  lv_style_set_line_color(&style_arc_indic, LV_STATE_DEFAULT, LV_COLOR_GRAY);
  ...
  lv_style_set_line_color(&style_arc_bg, LV_STATE_DEFAULT, LV_IT_COLOR_BUTTON);
  ...
  lv_style_set_bg_color(&style_arc_knob, LV_STATE_DEFAULT, LV_COLOR_SILVER);
